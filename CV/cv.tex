...
\name{Dmitry}{Kovalev}
\address{2225-WS19, Building 1, King Abdullah University of Science and Technology, Thuwal, 23955, Saudi Arabia}
\mobile{+7 905 719 06 98}

\email{dmitry.kovalev@kaust.edu.sa}
\homepage{dmitry-kovalev.com}
\github{dakovalev1}
%\linkedin{posquit0}
%\skype{skypeid}
...
\makecvfooter{\today}{Dmitry Kovalev~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
